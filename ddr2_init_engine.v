...
`define S_PRE1	17'd100200 // First Precharge
`define S_NOP2	17'd100202 // NOP after Precharge
`define S_EMRS2	17'd100208 // Set EMRS 2
`define S_NOP3 	17'd100210 // NOP after EMRS 2
`define S_EMRS3	17'd100212 // Set EMRS 3
`define S_NOP4	17'd100214 // NOP after EMRS 3
`define S_DLL	17'd100216 // DLL Set
`define S_NOP5	17'd100218 // NOP after DLL Set
`define S_DLLR	17'd100220 // DLL Reset
`define S_NOP6	17'd100222 // NOP after DLL Reset
`define S_PRE2	17'd100224 // 2nd Precharge
`define S_NOP7	17'd100226 // NOP after 2nd Precharge
`define S_AUTO1	17'd100232 // Part 1 of Auto Refresh for 54 clocks
`define S_NOP8	17'd100234 // NOP after Auto Refresh 1 
`define S_AUTO2 17'd100286 // Send Auto Refresh for 54 clocks
`define S_NOP9	17'd100288 // NOP after Auto Refresh 2 
`define S_MRS	17'd100340 // Set MRS register
`define S_NOP10	17'd100342 // NOP afer MRS
`define S_EMRS1	17'd100344 // Set EMRS1 register
`define S_NOP11	17'd100346 // NOP after EMRS1
`define S_OCD	17'd100620 // OCD Calibration 400 clocks after DLLR
`define S_NOP12 17'd100622 // NOP after OCD calibration
`define S_PRE3	17'd100626 // Third Precharge
`define S_NOP13	17'd100628 // NOP after Precharge
`define S_ODT	17'd100634 // Raise ODT When memory is ready
`define S_DONE	17'd100636 // Memory is ready
	...
	// ----------------------------------------------------------
        ...
        // Rest of the values are set to desired values too (else it throws errors)
	        ...
	        `S_DLL: begin
        	        {csbar, rasbar, casbar, webar} <= 4'b0000; // EMRS command
        	        a[0] <= 1'b0; // DLL Enable
               		a[1] <= 1'b0; // Output Driver
                	a[2] <= 1'b0; // Rtt ODT
                	a[6] <= 1'b0; // Rtt ODT

			// FILL IN VALUES
                	a[5:3] <= 3'b100; // Additive CAS
	...
	// Need to wait same time as last refresh before issuing the next command
        ...
        // ----------------------------------------------------------
        	...
        	`S_EMRS1: begin
                	{csbar, rasbar, casbar, webar} <= 4'b0000; // EMRS command 
                	a[0] <= 1'b0; // DLL Enable
					a[1] <= 1'b0; // Output Driver Impedence
        	        a[2] <= 1'b1; // Rtt ODT
        	        a[6] <= 1'b0; // Rtt ODT
        	        a[5:3] <= 3'b100; // Additive CAS Latency
					a[9:7] <= 3'b111; // OCD Calibration
	                a[10] <= 1'b1; // DLL Reset
        	        a[11] <= 1'b0; // Write recovery
                	a[12] <= 1'b0; // Fast Exit
                	ba <= 2'b01; // EMRS1
	                end
